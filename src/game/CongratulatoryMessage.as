package game
{
	...
	public class  CongratulatoryMessage extends World
	{
		...
		private var to_credits:EndButton;
		...
		public function CongratulatoryMessage(source:*) {
			...
			{	
				drawBox("Level " + mediator.theLevel + " \n Time: " + mediator.game_data.data.tempTime + "\n" 
			...
			{
				mediator.totalScores = mediator.thecoinsnum;
				to_credits = new EndButton(200, 500, "Continue to " + "\n" + "Credits", 150, 55, continuetoCredits);
				drawBox("Level " + mediator.theLevel+ " Time: " + mediator.game_data.data.tempTime + "\n" 
					+ "Your score for this level: " +  formulascore() + "\n"
					+ "Your overall score: " + mediator.totalScores);
		...
		public function continuetoCredits():void {
